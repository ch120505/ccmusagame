      ...
      //     btn.
       //   btn.showsTouchWhenHighlighted = true
        ...
        stackView.alignment = .center
          ...
          stackView.addArrangedSubview(btnFalse)
          stackView.addArrangedSubview(btnTrue)
        ...
        //    lblQuestion.topAnchor.constraint(equalTo: lblTimer.bottomAnchor, constant: 60).isActive = true
         //   lblQuestion.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor).isActive = true
           ...
           // lblQuestion.rightAnchor.constraint(equalTo: view.rightAnchor, constant: 38).isActive = true
            if UIDevice.current.userInterfaceIdiom == .pad
            {
                lblTimer.font = UIFont.systemFont(ofSize: 26, weight: .semibold)
                txtProgress.font = UIFont.systemFont(ofSize: 30, weight: .semibold)
                lblQuestion.font = UIFont.systemFont(ofSize: 30, weight: .semibold)
                lblQuestion.heightAnchor.constraint(equalToConstant: 110).isActive = true
                lblQuestion.leftAnchor.constraint(equalTo: view.leftAnchor,constant: 300).isActive = true
                lblQuestion.topAnchor.constraint(equalTo: lblTimer.bottomAnchor, constant: 170).isActive = true
            }
            else
            {
                txtProgress.font = UIFont.systemFont(ofSize: 20, weight: .semibold)
            ...
            if UIDevice.current.userInterfaceIdiom == .pad
            {
                svButtons2.topAnchor.constraint(equalTo:  imageView.bottomAnchor, constant: 100).isActive = true
               
                svButtons2.heightAnchor.constraint(equalToConstant: 110).isActive = true
            }
            else
            {
                svButtons2.topAnchor.constraint(equalTo: imageView.bottomAnchor, constant: 40).isActive = true
              
                svButtons2.heightAnchor.constraint(equalToConstant: 60).isActive = true
             
            }
            svButtons2.leadingAnchor.constraint(equalTo: view.leadingAnchor).isActive = true
           ...
           // svButtons2.widthAnchor.constraint(equalToConstant: 60).isActive = true
            svButtons2.translatesAutoresizingMaskIntoConstraints = false
   ...
   /*
       ...
       //
        ...
        /*
            ...
            if UIDevice.current.userInterfaceIdiom == .pad
            {
                actionSheet = UIAlertController(title: title, message: message, preferredStyle: .alert)
            }
            else
            {
