...
//    var QImage: UIImage = UIImage(named: "sudoku")!
  ...
  //  var xx: Character = ""
   ...
   //     print("carl read json  file ansSting  = \(ansString[0]) = \(ansString[1]) = \(ansString[2])")
      ...
      //  viewProgress.topAnchor.constraint(equalTo: lblText.topAnchor,constant: 20 ).isActive = true
        ...
        /*
         if UIDevice.current.userInterfaceIdiom != .pad
         {
             ...
             imageView.topAnchor.constraint(equalTo: lblTimer.bottomAnchor, constant: 80).isActive = true
             ...
             imageView.heightAnchor.constraint(equalToConstant: 750).isActive = true  // 208
             imageView.widthAnchor.constraint(equalToConstant: 700).isActive = true  // 400
    ...
    else
    {
        ...
        imageView.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 10).isActive = true
        imageView.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -16).isActive = true
        imageView.heightAnchor.constraint(equalToConstant: 480).isActive = true  // 208
        imageView.widthAnchor.constraint(equalToConstant: 580).isActive = true  // 400
        imageView.image = UIImage(named: "Chooseq")
    }  */
    ...
    //    imageView.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -16).isActive = true
        ...
        if UIDevice.current.userInterfaceIdiom == .pad
        {
            ...
            if UIDevice.current.userInterfaceIdiom == .pad  && ScreenSize.SCREEN_MAX_LENGTH == 1366.0
            {
                ...
                imageView.widthAnchor.constraint(equalToConstant: 650).isActive = true
            }
            else
            {
                //
                // pad 10th G and PAD Mini
                //
        ...
        lblQuestion.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -50).isActive = true   // -50
        lblQuestion.heightAnchor.constraint(equalToConstant: 60).isActive = true
        lblQuestion.translatesAutoresizingMaskIntoConstraints = false
  //      lblQuestion.leftAnchor.constraint(equalTo: view.leftAnchor,constant: 50).isActive = true // 125
       // lblQuestion.rightAnchor.constraint(equalTo: view.rightAnchor, constant: 38).isActive = true
        if UIDevice.current.userInterfaceIdiom == .pad
        {
            // 聖經最長是哪章
            lblQuestion.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 20).isActive = true   // 20
            lblQuestion.topAnchor.constraint(equalTo: lblTimer.bottomAnchor, constant: 190).isActive = true
            lblQuestion.heightAnchor.constraint(equalToConstant: 80).isActive = true
            lblQuestion.leftAnchor.constraint(equalTo: view.leftAnchor,constant: 300).isActive = true // 125 聖經最長是哪章 --->
            lblQuestion.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -10).isActive = true
            lblQuestion.font = UIFont.systemFont(ofSize: 26, weight: .semibold)
        }
        else
        {
            lblQuestion.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 20).isActive = true   // 20
            ...
            lblQuestion.font = UIFont.systemFont(ofSize: 20, weight: .semibold)
            lblQuestion.leftAnchor.constraint(equalTo: view.leftAnchor,constant: 130).isActive = true //  聖經最長是哪章--->
        ...
        ansCollection.trailingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.trailingAnchor, constant: -16).isActive = true   // 16
      
        ansCollection.widthAnchor.constraint(equalToConstant: view.frame.width).isActive = true
        
        if UIDevice.current.userInterfaceIdiom == .pad
        {
            ansCollection.topAnchor.constraint(equalTo:  imageView.bottomAnchor,constant: 200).isActive = true   // 200 iphone
          
            ansCollection.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 50).isActive = true  // 16
            ansCollection.heightAnchor.constraint(equalToConstant: 250 ).isActive = true   // 可以27答案
          
            lblMessage.font = UIFont.systemFont(ofSize: 30, weight: .semibold)
           
        }
        else
        {
            ansCollection.topAnchor.constraint(equalTo:  lblQuestion.bottomAnchor,constant: 200).isActive = true   // 200 iphone
          
            ansCollection.leadingAnchor.constraint(equalTo: view.safeAreaLayoutGuide.leadingAnchor, constant: 16).isActive = true  // 16
            lblMessage.font = UIFont.systemFont(ofSize: 20, weight: .semibold)
   ...
   //     if UIDevice.current.userInterfaceIdiom == .pad
    ...
    func DisplayAnsMessage(at flag :Bool)
    {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad
        {
            alert = UIAlertController(title: "看結果",
                                          message: message,
    ...
    func showAnsMessage(at flag :Bool)
    {
        if flag == true  {
 ...
 //       print("Carl currentQuestion = \(GameName.shared.currentQuestion)")
        ...
        {
          //   print("carl Title \(GameName.shared.bibles[position].Title)")
    ...
    func GameOverAlert(title:String, message:String)
    {
        if UIDevice.current.userInterfaceIdiom == .pad
        {
            ...
            let rect = CGRect(x: margin, y: margin, width: dialogMessage.view.bounds.size.width - margin * 4.0, height: 120)
            let customView = UIView(frame: rect)
            dialogMessage .view.addSubview(customView)
            ...
            dialogMessage.setTitlet(font: UIFont.boldSystemFont(ofSize: 26), color: UIColor.blue)
            dialogMessage.setMessage(font: UIFont(name: "AvenirNextCondensed-HeavyItalic", size: 26), color: UIColor.blue)
            
            //Add OK and Cancel button to dialog message
            dialogMessage.setBackgroundColor(color: UIColor.white)
