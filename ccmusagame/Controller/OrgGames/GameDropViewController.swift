       ...
       //  TimeLabel.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 200).isActive = true
        ...
        TimeLabel.widthAnchor.constraint(equalToConstant: 150).isActive = true
         ...
         else
         {
             ...
             {
                 qnsCollection.heightAnchor.constraint(equalToConstant: 200).isActive = true  // 900
             }
             else
             {
         ...
         ansCollection.topAnchor.constraint(equalTo:  qnsCollection.bottomAnchor,constant: 20).isActive = true  // 50  90
        ...
        if UIDevice.current.userInterfaceIdiom == .pad
        {
            ansCollection.heightAnchor.constraint(equalToConstant: 300  ).isActive = true
        }
        else
        {
            ansCollection.heightAnchor.constraint(equalToConstant: 200  ).isActive = true
        }
        // 可以27答案 150
         ...
         svButtons3.topAnchor.constraint(equalTo: ansCollection.bottomAnchor, constant: 20).isActive = true // 50
         ...
         svButtons3.heightAnchor.constraint(equalToConstant: 60).isActive = true // 40
      //   svButtons3.widthAnchor.constraint(equalToConstant: 60).isActive = true // 40
         svButtons3.translatesAutoresizingMaskIntoConstraints = false
