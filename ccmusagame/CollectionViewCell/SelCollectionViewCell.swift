  ...
  //  static let identifier = "SewlCollectionViewCell"
    ...
    func  setupView()
    {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad
        {
            ...
            {
                imagestar1.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 20.0).isActive = true
                ...
                imagestar1.heightAnchor.constraint(equalToConstant: 40).isActive = true
                imagestar1.widthAnchor.constraint(equalToConstant:  40).isActive = true
                
                imagestar2.leftAnchor.constraint(equalTo: self.leftAnchor,constant: 30).isActive = true
                imagestar2.rightAnchor.constraint(equalTo: self.rightAnchor,constant: -40).isActive = true
                imagestar2.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 1.0).isActive = true
                imagestar2.heightAnchor.constraint(equalToConstant: 200).isActive = true
                imagestar2.widthAnchor.constraint(equalToConstant:  200).isActive = true
            }
            else
            {
                imagestar1.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 8.0).isActive = true
                imagestar1.leftAnchor.constraint(equalTo: self.leftAnchor,constant: 30).isActive = true
                imagestar1.rightAnchor.constraint(equalTo: self.rightAnchor,constant: -90).isActive = true
                imagestar1.heightAnchor.constraint(equalToConstant: 40).isActive = true
                imagestar1.widthAnchor.constraint(equalToConstant:  40).isActive = true
                imagestar2.leftAnchor.constraint(equalTo: self.leftAnchor,constant: 20).isActive = true
                imagestar2.rightAnchor.constraint(equalTo: self.rightAnchor,constant: -40).isActive = true
                imagestar2.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 1.0).isActive = true
                imagestar2.heightAnchor.constraint(equalToConstant: 150).isActive = true
                imagestar2.widthAnchor.constraint(equalToConstant:  150).isActive = true
            }
        }
        else
        {
        ...
        if UIDevice.current.userInterfaceIdiom == .pad
        {
            imagestar3.heightAnchor.constraint(equalToConstant: 150).isActive = true
            imagestar3.widthAnchor.constraint(equalToConstant:  150).isActive = true
        }
        else
        {
